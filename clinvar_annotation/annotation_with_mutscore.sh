...
perl $script/table_annovar.pl $path/$name.avinput $here/00_scripts/clinvar_annotation/humandb -intronhgvs 1000000 -protocol ClinPred,dbscsnv11,CONDEL,dbNSFP4.0a,pext,mutscore -operation f,f,f,f,f,f -build hg19 -nastring . -remove -polish 
